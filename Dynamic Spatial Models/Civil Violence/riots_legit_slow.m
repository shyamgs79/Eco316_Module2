%Main program modified for gradual but severe decrease in legitimacy
...
for t=1:numruns
    ...
    %In each run, legitimacy decreased by 0.001. At the end of 200 runs,
    %Lfinal=Lstart-200*(0.001) = 0.7
    L=L-0.001;
    ...
    figure(2)
    plot(1:t,countactive(1:t),'r+-',1:t,countjailed(1:t),'b^-', 1:t,countquiet(1:t),'co-');
    axis square
